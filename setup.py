...
setuptools.setup(
    ...
    download_url="https://github.com/grsharman/detritalPy/archive/v1.3.24.tar.gz",
    install_requires=['numpy','matplotlib','pandas','openpyxl','folium','vincent','simplekml',
        'scipy','sklearn','KDEpy','peakutils'],
    classifiers=[
